...
class ResponseProcessorTests: XCTestCase {
    ...
    func testSuccessfulResponse() {
        ...
        // Execute
        let result: APIResponse<TestModel> = responseProcessor.process(data: jsonData, response: response, error: nil)
    ...
    func testSuccessfulEmptyResponse() {
        ...
        let result: APIResponse<Void> = responseProcessor.process(data: nil, response: response, error: nil)
    ...
    func testUnderlyingError() {
        ...
        // Execute
        let result: APIResponse<TestModel> = responseProcessor.process(data: nil, response: nil, error: testError)
    ...
    func testInvalidResponse() {
        ...
        // Execute
        let result: APIResponse<TestModel> = responseProcessor.process(data: nil, response: invalidResponse, error: nil)
    ...
    func testUnauthorizedError() {
        ...
        // Execute
        let result: APIResponse<TestModel> = responseProcessor.process(data: nil, response: response, error: nil)
    ...
    func testServerError() {
        ...
        // Execute
        let result: APIResponse<TestModel> = responseProcessor.process(data: errorData, response: response, error: nil)
    ...
    func testDecodingError() {
        ...
        // Execute
        let result: APIResponse<TestModel> = responseProcessor.process(data: invalidJsonData, response: response, error: nil)
    ...
    func testMalformedJson() {
        ...
        // Execute
        let result: APIResponse<TestModel> = responseProcessor.process(data: malformedJsonData, response: response, error: nil)
    ...
    func testProcessWithError() {
        ...
        // When
        let result: Result<String, Error> = responseProcessor.process(response: nil, data: nil, error: testError)
    ...
    func testProcessWithInvalidResponse() {
        ...
        // When
        let result: Result<String, Error> = responseProcessor.process(response: invalidResponse, data: nil, error: nil)
    ...
    func testProcessWithUnsuccessfulStatusCode() {
        ...
        for statusCode in statusCodes {
            ...
            // When
            let result: Result<String, Error> = responseProcessor.process(response: response, data: nil, error: nil)
    ...
    func testProcessWithNonDecodableData() {
        ...
        // When
        let result: Result<TestModel, Error> = responseProcessor.process(response: response, data: invalidJSON, error: nil)
    ...
    func testProcessWithValidDecodableData() {
        ...
        // When
        let result: Result<TestModel, Error> = responseProcessor.process(response: response, data: validJSON, error: nil)
    ...
    func testProcessWithStringData() {
        ...
        // When
        let result: Result<String, Error> = responseProcessor.process(response: response, data: stringData, error: nil)
    ...
    func testProcessWithRawData() {
        ...
        // When
        let result: Result<Data, Error> = responseProcessor.process(response: response, data: testData, error: nil)
