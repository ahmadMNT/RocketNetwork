...
Add NetworKit as a dependency to your Package.swift file:

```swift
dependencies: [
    .package(url: "path/to/NetworKit", .upToNextMajor(from: "1.0.0"))
]
```
...
NetworKit is available under the MIT license. 
